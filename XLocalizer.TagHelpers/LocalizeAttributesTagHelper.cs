...
namespace XLocalizer.TagHelpers
{
    ...
    {
        private readonly IXStringLocalizerFactory _stringFactory;
        ...
        public LocalizeAttributesTagHelper(IXHtmlLocalizerFactory htmlFactory, IXStringLocalizerFactory stringFactory)
            : base(htmlFactory)
        {
